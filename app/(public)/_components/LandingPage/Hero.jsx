...
const Hero = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-red-50 to-gray-50 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Get Fit <span className="text-red-600">for You</span>
            </motion.h1>
            <motion.p 
              ...
              transition={{ duration: 0.6 }}
            >
              ThrivBeat empowers mature adults with safe, guided exercise programs 
              designed to support chronic-condition recovery and lifelong heart health.
            </motion.p>
            ...
            >
              {[
                { icon: Heart, text: "Heart-healthy exercise programs" },
                { icon: Shield, text: "Safe for chronic conditions" },
