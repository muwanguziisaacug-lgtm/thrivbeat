				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="text-center mb-16">
						...
						<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
							...
							Reach out with any questions, concerns, or feedback.
							Our team is ready to support you every step of the
							way.
						</p>
					</div>
								...
								<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
									<div className="text-center">
										...
										<p className="text-muted-foreground text-sm">
											Need help with your account, videos,
											or subscription? We're here to
											assist.
										</p>
									</div>
									<div className="text-center">
										...
										<p className="text-muted-foreground text-sm">
											Questions about form, modifications,
											or which exercises are right for
											you?
										</p>
									</div>
									<div className="text-center">
										...
										<p className="text-muted-foreground text-sm">
											Have feedback, suggestions, or just
