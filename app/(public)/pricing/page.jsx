...
import EventsComponent from "./_components/EventsComponent";
    ...
    try {
      ...
      if (!statusRes.ok || !status.authenticated) {
        ...
        const nextUrl = encodeURIComponent(
          `/pricing?plan=${planName.toUpperCase()}&period=${period}`
        );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Select the plan that fits your needs and start your path to better
              health today. All plans include our safe, expert-guided exercise
              programs.
            </p>
          ...
          {/* <div className="mb-16 mt-20">
            <div className="bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-8 md:p-10 text-primary-foreground">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <div className="inline-block bg-primary-foreground/20 text-primary-foreground text-sm font-semibold px-4 py-1 rounded-full mb-4">
                    Face to Face (Scotland Only)
                  </div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-4">
                    Face-to-Face Training
                  </h2>
                  <p className="text-primary-foreground/90 text-lg mb-6">
                    Get personalized one-on-one training with our certified
                    instructors. Available online via video call or in-person
                    for clients based in Scotland.
                  </p>
                  ...
                  <Button
                    size="lg"
                    className="text-lg px-8 bg-red-600 text-white"
                  >
                    Book a Session
                  </Button>
                </div>
                <div className="text-center md:text-right">
                  <div className="inline-block bg-primary-foreground/10 rounded-2xl p-8">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                    <tr>
                      <td className="px-6 py-4 text-sm ">Exercise Videos</td>
                    ...
                    <tr className="bg-background">
                      <td className="px-6 py-4 text-sm ">Progress Tracking</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 text-sm ">Email Support</td>
                      <td className="px-6 py-4 text-center">
                        <Check className="w-5 h-5 text-green-500 mx-auto" />
                      </td>
                      <td className="px-6 py-4 text-center text-sm text-gray-700">
                    ...
                    <tr className="bg-background">
                      <td className="px-6 py-4 text-sm ">Group Video Calls</td>
            ...
            <div className="max-w-3xl mx-auto space-y-6 text-left">
              <div className="bg-background  rounded-lg p-6 shadow-lg shadow-gray-800">
                ...
                <p className="text-muted-foreground">
                  Yes! All plans include a 7-day free trial. You can cancel
              ...
              <div className="bg-background  rounded-lg p-6 shadow-sm shadow-gray-800">
                ...
                <p className="text-muted-foreground">
                  Our exercises are designed specifically for mature adults with
                  chronic conditions. However, we always recommend consulting
                  with your healthcare provider before starting any new exercise
                  program.
                </p>
              </div>
              <div className="bg-background  rounded-lg p-6 shadow-sm shadow-gray-800">
                ...
                <p className="text-muted-foreground">
                  ...
                  time. Changes will take effect at your next billing cycle.
                </p>
              </div>
            </div>
          </div>
